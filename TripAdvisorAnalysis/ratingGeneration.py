...
possible_nums=range(1,11) # int from 1 to 11
...
async def generateRating(row):
    ...
    row_num = row.name
    prompt = f"The following is a review from a customer who stayed at a hotel. Please rate the hotel on a scale from 1 to 10, with 1 being the worst and 10 being the best. Number only. \n\nReview: {review} \n\nRating: "
    try:
...
if __name__ == "__main__":
    ...
    results_df.to_csv('ratings_comparison_no_skew_110.csv', index=False)
